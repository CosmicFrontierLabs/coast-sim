from conops.targets.pointing import Pointing
...
class TestPointing:
    ...
    def test_exptime_setter_initializes_exporig(self, pointing: Pointing) -> None:
        # exporig is initialized to 1000 and doesn't change when exptime is set
        pointing.exptime = 500
        assert pointing.exporig == 1000
    ...
    def test_exptime_setter_second_set_preserves_exporig(
        self, pointing: Pointing
    ) -> None:
        # exporig stays at default value
        pointing.exptime = 500
        pointing.exptime = 1000
        assert pointing.exporig == 1000
    ...
    def test_done_property_when_exptime_zero(self, pointing: Pointing) -> None:
        pointing.exptime = 0
        # done is a field, not a computed property, so it remains False
        assert pointing.done is False

    def test_reset_resets_exptime_to_exporig(self, pointing: Pointing) -> None:
        pointing.exptime = 500
        ...
        # Reset
        pointing.reset()
        assert pointing.exptime == 1000  # Should be reset to exporig (which is 1000)

    def test_reset_sets_done_to_false(self, pointing: Pointing) -> None:
        pointing.exptime = 500
        pointing.begin = 100.0
        pointing.end = 200.0
        pointing.slewtime = 10.0
    ...
    def test_reset_sets_begin_to_zero(self, pointing: Pointing) -> None:
        pointing.exptime = 500
        pointing.begin = 100.0
        pointing.end = 200.0
        pointing.slewtime = 10.0
    ...
    def test_reset_sets_end_to_zero(self, pointing: Pointing) -> None:
        pointing.exptime = 500
        pointing.begin = 100.0
        pointing.end = 200.0
        pointing.slewtime = 10.0
    ...
    def test_reset_sets_slewtime_to_zero(self, pointing: Pointing) -> None:
        pointing.exptime = 500
        pointing.begin = 100.0
        pointing.end = 200.0
        pointing.slewtime = 10.0
