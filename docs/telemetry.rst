...
**Power System**
   ...
   - ``solar_array_drive_angles``: Current finite single-axis array-drive angles,
     each identified by configured panel index and name
   - ``solar_array_drive_angles_deg``: Compatibility property exposing only the
